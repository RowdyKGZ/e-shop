...
from account.serialaizers import RegisterSerializer, LoginSerializer, ProfileSerializer
...
class ActivationView(APIView):
    def get(self, request, activation_code):
        ...
        user.save()
        return Response('Ваш аккаут успешно активирован', status=status.HTTP_200_OK)
